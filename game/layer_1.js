...
function getTempCompEffect() {
  return getTempCompBase().pow(caplog10(game.tempComp).min(15).add(caplog10(getSpacetimeCompEffect())).add(inAnyGalChal()?0:game.superComp.temp)).div(game.timeFoam.pow(2))
}
